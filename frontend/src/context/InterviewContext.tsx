...
interface InterviewContextType {
  ...
  setSessionDuration: (duration: number | null) => void;
  resetInterview: () => void;
}
...
export function InterviewProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const savedDuration = localStorage.getItem('vocalace_session_duration');
    ...
    if (savedDuration) setSessionDuration(Number(savedDuration));
  }, []);
  ...
  useEffect(() => {
    if (sessionDuration) localStorage.setItem('vocalace_session_duration', String(sessionDuration));
    else localStorage.removeItem('vocalace_session_duration');
  }, [sessionDuration]);
